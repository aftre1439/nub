# 🌟 nub - Compress Your Text with Ease
...
4. After downloading, open your command line or terminal.

5. Navigate to the directory where you downloaded Nub.

6. Install Nub using the following command:
